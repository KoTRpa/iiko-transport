...
class Order extends Entity
{
    ...
    /**
     * @required
     * @var \KMA\IikoTransport\Entities\Deliveries\Response\Order\Customer Deliveries customer
     */
    public Customer $customer;

    /**
     * @required
     * @var string Deliveries phone number
     */
    public string $phone;

    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\DeliveryPoint Deliveries point details
    ...
    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\CancelInfo
     * Deliveries cancellation details. Required only if delivery is canceled, i.e. status=Canceled
     */
    public ?CancelInfo $cancelInfo = null;

    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\CourierInfo Driver information
     */
    ...
    /**
     * @required
     * @var string <yyyy-MM-dd HH:mm:ss.fff> Deliveries creation time in iikoFront (Local for the terminal)
     */
    public string $whenCreated;

    /**
     * @var string|null <yyyy-MM-dd HH:mm:ss.fff> Deliveries confirmation time (Local for the terminal).
     */
    ...
    /**
     * @var string|null <yyyy-MM-dd HH:mm:ss.fff> Deliveries dispatch time (Local for the terminal)
     */
    ...
    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\Problem Problem flag
     */
    public ?Problem $problem = null;

    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\Operator Operator that took order
     */
    public ?Operator $operator = null;

    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\MarketingSource Marketing source
     */
    ...
    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\ExternalCourierService ECS info.
    ...
    /**
     * @required
     * @var int Deliveries No
     */
    public int $number;

    /**
     * @var string|null Deliveries source
     */
    ...
    /**
     * @var string|null <yyyy-MM-dd HH:mm:ss.fff> Deliveries closing time (Local for delivery terminal).
     */
    public ?string $whenClosed = null;

    /**
     * @var null|\KMA\IikoTransport\Entities\Deliveries\Response\Order\Conception Concept
     */
    public ?Conception $conception = null;

    /**
     * @required
     * @var \KMA\IikoTransport\Entities\Deliveries\Response\Order\GuestsInfo Information about order guests
     */
    public GuestsInfo $guestsInfo;

    /**
     * @required
     * @var \Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Response\Order\OrderItem>
     * Order items
     */
    public Collection $items;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Response\Order\OrderCombo>
     * combos
     */
    public ?Collection $combos = null;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Response\Order\PaymentItem>
     * Payments
     */
    public ?Collection $payments = null;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Response\Order\TipsPaymentItem>
     * Tips
     */
    public ?Collection $tips = null;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Response\Order\DiscountItem>
     * Discounts
     */
    ...
    /**
     * @required
     * @var \KMA\IikoTransport\Entities\Deliveries\Response\Order\OrderType Order type
     */
