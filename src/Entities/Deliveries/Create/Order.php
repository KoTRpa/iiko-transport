...
class Order extends Entity
{
    ...
    /**
     * @var \KMA\IikoTransport\Entities\Deliveries\Create\DeliveryPoint|null Deliveries point details.
    ...
    /**
     * @required
     * @var \KMA\IikoTransport\Entities\Deliveries\Create\Customer Customer
     */
    public Customer $customer;

    /**
     * @var \KMA\IikoTransport\Entities\Deliveries\Create\Guests|null Guests information (count)
     */
    ...
    /**
     * @required
     * @var \Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Create\OrderItem> Order items
     * [iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.OrderItem]
     */
    public Collection $items;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Create\Combo> Combos included in order
     * Array of objects (iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.Combo)
     */
    public ?Collection $combos = null;

    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Create\Payment> Order payment components
    ...
    /**
     * @var null|\Illuminate\Support\Collection<int, \KMA\IikoTransport\Entities\Deliveries\Create\TipsPayment> Order tips components.
    ...
    /**
     * @var \KMA\IikoTransport\Entities\Deliveries\Create\DiscountsInfo|null Discounts/surcharges
     */
    public ?DiscountsInfo $discountsInfo = null;

    /**
     * @var \KMA\IikoTransport\Entities\Deliveries\Create\IikoCard5Info|null Information about iikoCard5
     */
