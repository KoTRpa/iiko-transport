...
class OrderInfo extends Entity
{
    ...
    /**
     * @var null|\KMA\IikoTransport\Entities\Delivery\Response\ErrorInfo Order creation error details
     * Required only if "creationStatus"="Error"
     */
    public ?ErrorInfo $errorInfo = null;

    /**
     * @var null|\KMA\IikoTransport\Entities\Delivery\Response\Order Order creation details
