...
{
    protected string $jsonPath = __DIR__ . '/ExternalCourierService.json';
    protected string $entityClass = \KMA\IikoTransport\Entities\Delivery\Response\Order\ExternalCourierService::class;
